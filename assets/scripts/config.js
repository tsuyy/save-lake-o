var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            title: '1950s – 1970s',
            image: '',
            description: 'The agriculture industry booms. Fertilizer becomes readily available and its widespread availability creates increased use which allows the agricultural industry to produce twice as many crops than usual. The increase in fertilizer leads to a detrimental accumulation of nutrients trapped in the soil. These are known as “legacy nutrients,” which are released into the earth as part of the natural water cycles runoff process and pose a major threat to aquifers.',
            location: {
                center: [ -81.29489, 26.92825],
                zoom: 8.7,
                pitch: 0,
